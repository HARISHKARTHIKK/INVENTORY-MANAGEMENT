...
export default function Header({ onMenuClick }) {
    ...
    return (
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 h-16 flex items-center justify-between px-4 md:px-6 sticky top-0 z-20 shadow-sm w-full">
